...
namespace PoGo.NecroBot.Logic.State
{
    public interface ISession
    {
        ...
        bool ReInitSessionWithNextBot(BotAccount authConfig = null, double lat = 0, double lng = 0, double att = 0);
    ...
    public class Session : ISession
    {
        ...
        public bool ReInitSessionWithNextBot(BotAccount bot = null, double lat = 0, double lng = 0, double att = 0)
        {
