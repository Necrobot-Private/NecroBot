...
namespace PoGo.NecroBot.Logic.Common
{
    ...
    public class Translation : ITranslation
    {
        ...
        [JsonProperty("PokemonStrings",
            ...
            ObjectCreationHandling = ObjectCreationHandling.Replace,
            DefaultValueHandling = DefaultValueHandling.Populate)]
        private readonly List<KeyValuePair<PokemonId, string>> _pokemonTranslationStrings = new List<KeyValuePair<PokemonId, string>>()
        {
        ...
        ObjectCreationHandling = ObjectCreationHandling.Replace,
        DefaultValueHandling = DefaultValueHandling.Populate)]
        private readonly List<KeyValuePair<PokemonMove, string>> _pokemonMovesetTranslationStrings =
