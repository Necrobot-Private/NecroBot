...
namespace PoGo.NecroBot.Logic.Tasks
{
    public static class FarmPokestopsTask
    {
        ...
        public static async Task Execute(ISession session, CancellationToken cancellationToken)
        {
            ...
            var response = await LocationUtils.UpdatePlayerLocationWithAltitude(session, new GeoCoordinate(session.Client.CurrentLatitude, session.Client.CurrentLongitude, session.Client.CurrentAltitude), session.Client.CurrentSpeed);
