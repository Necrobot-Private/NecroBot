...
namespace PoGo.NecroBot.Logic.Model.Settings
{
    ...
    public class TelegramConfig : BaseConfig
    {
        ...
        [NecrobotConfig (Description = "Allow control bot from Telegram comand", Position = 1)]
        ...
        [NecrobotConfig(Description = "Telegram API Key that require for the communication", Position = 2)]
