...
<strong>
Niantic has forced minimum version of Pokebot clients to 0.39.  So all bots, map scanners, and other unauthorized clients are going to down until the new API has been cracked.
